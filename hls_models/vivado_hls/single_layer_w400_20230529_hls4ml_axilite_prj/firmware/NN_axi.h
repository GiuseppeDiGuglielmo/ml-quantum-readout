...
void NN_axi(input_axi_t &in, output_axi_t *out, bool trigger, unsigned *window_size, unsigned *window_offset, unsigned *scaling_factor, unsigned *trigger_delay, unsigned *ou_buffer_head);
