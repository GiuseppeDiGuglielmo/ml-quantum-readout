...
int main(int argc, char **argv) {
    ...
    if (fin.is_open() && fpr.is_open()) {
        while (std::getline(fin, iline) && std::getline(fpr, pline)) {
            ...
            output_axi_t layer4_out[N_LAYER_5];
...
#if 0
                nnet::print_result<result_t, N_LAYER_5>(layer4_out, std::cout, true);
#else
                nnet::print_result<output_axi_t, N_LAYER_5>(layer4_out, std::cout, true);
#endif
            }
            e++;
...
#if 0
            nnet::print_result<result_t, N_LAYER_5>(layer4_out, fout);
#else
            nnet::print_result<output_axi_t, N_LAYER_5>(layer4_out, fout);
#endif
        }
        fin.close();
        fpr.close();
