...
struct config2 : nnet::dense_config {
    ...
    static const unsigned n_zeros = 1396;
    static const unsigned n_nonzeros = 1804;
    ...
    using product = nnet::product::weight_ternary<x_T, y_T>;
};
...
struct config7 : nnet::batchnorm_config {
    ...
    typedef exponent_scale7_t scale_t;
    template<class x_T, class y_T>
...
struct config8 : nnet::batchnorm_config {
    ...
    typedef exponent_scale8_t scale_t;
    template<class x_T, class y_T>
    using product = nnet::product::weight_exponential<x_T, y_T>;
};
