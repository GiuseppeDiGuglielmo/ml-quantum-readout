...
The data is **not stored in git**. It lives on the NAS at
`/nas/work/research/quantum/readout/data/`, and these paths in the repo are
symlinks to it:
...
To recreate the links on a machine that mounts the NAS, run `data/link_data.sh`.
